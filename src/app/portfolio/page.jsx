  ...
  return (
    ...
    >
            ...
            {items.map((item) => (
              ...
              >
                <div className="flex flex-col gap-8 text-white">
                  <h1 className="text-xl font-bold pt-4 md:text-2xl lg:text-4xl 2xl:text-8xl">
                    {item.title}
                  </h1>
                  <div className="relative w-80 h-56 md:w-96 md:h-64 lg:w-[420px] lg:h-[300px] 2xl:w-[600px] 2xl:h-[420px]">
      ...
      <div className="w-screen h-screen flex flex-col gap-16 items-center justify-center text-center mt-8">
        <h1 className="text-4xl xl:text-8xl">Do you have a project?</h1>
