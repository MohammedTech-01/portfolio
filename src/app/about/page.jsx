...
const AboutPage = () => {
  ...
  return (
    ...
    >
      {/* CONTAINER */}
      <div className={`h-screen overflow-y-scroll lg:flex ${styles.container}`} ref={containerRef}>
        {/* TEXT CONTAINER */}
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:pr-0 xl:w-2/3">
          {/* BIOGRAPHY CONTAINER */}
